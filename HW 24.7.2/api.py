...
class PetFriends:
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фото к уже созданному питомцу и возвращает статус запроса на сервер
        и результат в формате JSON с данными питомца, к которому было добавлено фото"""
